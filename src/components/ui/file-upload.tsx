    ...
    newFiles.forEach((fileData) => {
      ...
      const simulateUpload = setInterval(() => {
        setFiles((prevFiles) => {
          ...
          const idx = next.findIndex((f) => f.file === fileData.file);
          if (idx === -1) {
                ...
                <div className="text-xs text-muted-foreground">
                  {fileData.error ? (
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {fileData.uploaded ? (
                        <span className="flex items-center gap-1 text-[#0f6b7a]">
      ...
      <div
        className={cn(
          ...
          isDragging
            ...
            : "border-muted-foreground/25 hover:border-[#0f6b7a]/50",
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center gap-2">
          ...
          <div className="text-sm text-muted-foreground">
            or{" "}
            <span className="text-[#0f6b7a]/50 font-medium">browse files</span>
          </div>
